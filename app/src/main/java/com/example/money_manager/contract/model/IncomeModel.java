...
public class IncomeModel implements IncomeContract.Model {
    ...
    @Override
    public void delete(String id, onTransactionListener listener) {
    ...
    @Override
    public void update(Transaction transactionn, String id, onTransactionListener listener) {
        DocumentReference category = firestore
                .collection("categories")
    ...
    @Override
    public void load(String id, onTransactionListener listener) {
        firestore
                .collection(TRANSACTION_COLLECTION)
                .document(id)
                .get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            DocumentSnapshot q = task.getResult();
                            double amount = q.get("amount", double.class);
                            String description = q.get("description", String.class);
